...
public class ConnectionConfiguration {
    ...
    public void setEnableOAuth2Authentication(String enableOAuth2Authentication) {

        if (!StringUtils.isEmpty(enableOAuth2Authentication)) {
            this.enableOAuth2 = Boolean.parseBoolean(enableOAuth2Authentication);
        }
    }
